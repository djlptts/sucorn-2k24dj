...
single image case, hard to see for those more than 1
{
    "imagePanels": [
        {
        "prompt": ""in an anime there is a young white skinned male with black hair and his blonde haired wife dressed in workout clothing bouncing up and down on two giant, oversized orange space hopper ballsanime style",
        "generatedImages": [
            {
            "encodedImage": "",
            "seed": 329995,
